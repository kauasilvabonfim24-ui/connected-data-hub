      ...
      <div className="flex min-h-screen items-center justify-center bg-brand px-4">
        <div className="card w-full max-w-sm p-6 text-center">
          ...
          <p className="mt-2 text-sm text-ink-muted">
            ...
            e começar a usar o Servix IA.
          </p>
          <Link to="/login" className="btn-primary mt-5 inline-flex">Ir para o login</Link>
        </div>
      </div>
    )
  }
    ...
    <div className="flex min-h-screen items-center justify-center bg-brand px-4 py-10">
      <div className="w-full max-w-sm">
        <div className="mb-8 flex flex-col items-center text-center">
          ...
          <p className="mt-1 text-sm text-brand-100">Comece a automatizar seu atendimento hoje.</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="card p-6">
          ...
          <input id="nome" required className="input mb-4" value={nome} onChange={(e) => setNome(e.target.value)} />
